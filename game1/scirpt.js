// ======================= 独立映射卡片库 =======================
    const keywordCardMap = {
        ...
        "来自D的爆料": "【来自D的爆料】'老板上周让我去书店买一本诗集和一本……呃，我不太好意思说。'",
        ...
        "爱照顾人": "【爱照顾人】'柯克兰先生会记住每个人的咖啡口味。他知道Hero喜欢双层芝士汉堡加冰可乐。'",
        "搜素记录": "【搜素记录】搜索记录里除了“市场占有率”等名词，最后一行赫然写着：'23岁的人会喜欢什么？''",
        ...
        "可乐": "【可乐】阿尔弗雷德喝可乐的声音总是很响。",
        "汉堡店": "【汉堡店】你搜索到的消息显示，阿尔弗雷德每天带两份汉堡。'",
        ...
        // === 羁绊类 ===
        "罢工少女的恋爱咨询": "【罢工少女的恋爱咨询】经过咨询，罢工少女建议你向'眉毛'借阅一本时尚杂志。",
        "弗朗西斯的恋爱咨询": "【弗朗西斯的恋爱咨询】经过咨询，弗朗西斯告诉你，笨蛋情侣连告白都藏在字母里。",
        "couples": "【couples】作为公司的积极罢工业务，弗朗西斯积极地向情侣们提供love的解答。",
        "love的解答": "【love解答】'对于hero来说，可要好好想想H和S这两个字母'",
        "菊的小说": "【菊的小说】菊写了一本关于公司员工情感生活的轻小说。",
        ...
        "书架": "【书架】考古学书籍旁常年放着一本翻旧的诗集。书页间的借阅卡上，AFJ 与 A.K. 的字迹交替出现。'",
        "周年庆摄影集": "【周年庆摄影集】一张抓拍照片。画面中，19岁的阿尔弗雷德正试图给23岁的亚瑟戴上一顶滑稽的派对纸帽子。\n\n照片背面有一行退色的小字：“关于‘英雄与领主’的第1923次非正式会议。",
        ...
        "四个英文字母": "【四个英文字母】你想到hero和lord的名字都是四个字母，难道神秘的四个英文字母也是某种暗号吗？'",
